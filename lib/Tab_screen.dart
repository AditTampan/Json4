              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color.fromARGB(255, 68, 67, 129), // Soft pink for the bubble background
      ...
      child: Column(
        ...
        children: [
          Center(
            child: CircleAvatar(
              radius: 60,
              backgroundImage: AssetImage('adot.jpg'), // Ensure the path is correct
            ),
          ),
          SizedBox(height: 20),
          Center(
          ...
          ListTile(
            ...
            subtitle: Text('Aditya Pratama'),
          ),
          ListTile(
            leading: Icon(Icons.cake, color: Colors.teal),
            title: Text('Tanggal Lahir'),
            subtitle: Text('6 Agustus 2006'),
          )
        ],
      ),
    );
